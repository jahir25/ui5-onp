		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ONP",
									"targetURL": "#ui5onpcompeui5onp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5onpcompeui5onp-display": {
								"semanticObject": "ui5onpcompeui5onp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5onp.com.pe.ui5onp",
									"url": sap.ui.require.toUrl("ui5onp/com/pe/ui5onp")
								}
							}
						}
					}
